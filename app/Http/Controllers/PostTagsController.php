...
class PostTagsController extends Controller
{
    ...
    public function update(PostTagsRequest $request, $id)
    {
        ...
        // Save tags image...
        // if (isset($request->tags_image) && $request->tags_image != null) {
        //     $tags->clearMediaCollection('tags_image');
        //     $tags->addMediaFromRequest('tags_image')->toMediaCollection('tags_image');
        // }
