                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                        <label for="status" class="form-control-label">{{ __('message.status') }} <span
                                                class="text-danger">*</span></label>
                                        <select name="status" id="status" class="form-control select2js" required>
                                            ...
                                            <option value="inactive" {{ old('status', isset($data) ? $data->status : '') == 'inactive' ? 'selected' : '' }}>{{ __('message.inactive') }}
                                            </option>
                                        </select>
                                    </div>
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="">
                                            <input class="form-control file-input" type="file" name="category_image"
                                                accept="image/*">
                                        </div>
                                    </div>
                                    ...
                                    @if(isset($id) && getMediaFileExit($data, 'category_image'))
                                        <div class="col-md-2 mb-2 position-relative">
                                            <img id="category_image_preview"
                                                src="{{ getSingleMedia($data, 'category_image') }}" alt="equipment-image"
                                                class="avatar-100 mt-1">
                                            <a class="text-danger remove-file"
                                                href="{{ route('remove.file', ['id' => $data->id, 'type' => 'category_image']) }}"
