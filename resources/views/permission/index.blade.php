@php use App\Helpers\AuthHelper; @endphp
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    @foreach ($roles as $role)
                                                                        <td class="text-center">
                                                                            <input class="form-check-input" type="checkbox" id="role-{{$role['id']}}-permission-{{$permission['id']}}" name="permission[{{$permission['name']}}][]" value='{{$role['title']}}'
