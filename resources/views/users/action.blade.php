...
<div class="d-flex align-items-center">
    ...
    @if($auth_user->can('user-delete'))
        <a class="btn btn-sm btn-icon btn-danger" href="javascript:void(0)" data-bs-toggle="tooltip" data--submit="user{{$id}}" 
    ...
    @endif
    <form action="{{ route('users.destroy', $id) }}" method="POST" data--submit="user{{ $id }}" style="display: none;">
        @method('DELETE')
        @csrf
    </form>
</div>
